...
db.burgers.insertMany([
  {
    protein: 'beef',
    cheese: 'slice',
    toppings: ['ketchup', 'pickles', 'mayo', 'onions']
  },
  {
    protein: 'beef',
    cheese: 'slice',
    toppings: ['ketchup', 'onions', 'mushrooms']
  },
  { protein: 'chicken', toppings: ['onions', 'mustard'] },
  { protein: 'turkey', cheese: 'slice', toppings: ['ketchup', 'relish'] },
  { protein: 'beef', toppings: ['ketchup', 'peppers', 'mushrooms'] }
])
...
db.burgers.findOne({ cheese: 'slice' })
// find one and update the first burger with cheese to have a property of 'double cheese'
db.burgers.updateOne({ cheese: 'slice' }, { $set: { cheese: 'double cheese' } })
...
db.burgers.find({ toppings: { $all: ['ketchup'] } })
// find all the burgers with pickles (or a topping you used more than once) and remove the pickles
db.burgers.updateMany(
  { toppings: 'mushrooms' },
  { $pull: { toppings: 'mushrooms' } }
)
